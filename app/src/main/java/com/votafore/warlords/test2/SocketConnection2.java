...
public class SocketConnection2 implements IConnection {
    ...
    public SocketConnection2(final Socket socket, Handler handler, ISocketListener listener) throws IOException{
